...
사용자와 컴퓨터 간의 커뮤니케이션. 왜? 주어진 문제를 해결하기 위해! 어떻게? 컴퓨팅 사고(CT)를 통해 기계에게 보다 정확하고 상세하게
기계어를 사람이 알기 힘들기에 컴파일러를 통해 상호작용, 그래서 그 컴파일러에 맞게 작성해야한다. 즉, 문법(Syntax)과 의미(Semantics)에 맞춰서
